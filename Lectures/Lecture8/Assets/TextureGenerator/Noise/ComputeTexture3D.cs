...
public class ComputeTexture3D : ComputeTexture {
    ...
    public override void CreateRenderTexture(){
        ...
        RenderTextureDescriptor rtDesc = new RenderTextureDescriptor(squareResolution, squareResolution, RenderTextureFormat.ARGB32, 0);
        rtDesc.enableRandomWrite = true;
        rtDesc.dimension = UnityEngine.Rendering.TextureDimension.Tex3D;
        rtDesc.volumeDepth = squareResolution;
